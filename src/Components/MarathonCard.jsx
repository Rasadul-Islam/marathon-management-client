            ...
            <div className="card bg-gray-100 w-[320px] h-[500px] shadow-xl border-2 border-gray-500 mx-auto">
                ...
                <div className='px-5 mt-2'>
                    ...
                    <h1 className='text-lg font-semibold mt-1'>
                        ...
                        <span className='pl-8'>Start - {startRegistration}</span><br />
                        <span className='pl-8'>End - {startRegistration}</span>
                    </h1>
                    ...
                    <div className='w-full'>
                        <Link to={`/marathonDitails/${_id}`}
                            className='btn bg-lime-300 border-2 border-gray-400 font-bold text-lg w-full mt-2' >See More
                        </Link>
                    </div>
                </div>
            </div>
